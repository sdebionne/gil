...
inline void write_view(
    ...
    typename std::enable_if<mp11::mp_and<
        ...
        typename is_write_supported<
            ...
            typename Writer::format_tag_t>::type>::value>::type* /* ptr */
    = nullptr)
{
    writer.apply(view);
}
...
inline void write_view(
    ...
    typename std::enable_if<mp11::mp_and<
        ...
        typename is_write_supported<typename get_pixel_type<View>::type, FormatTag>::type>::value>::
        type* /* ptr */
    = nullptr)
{
...
inline void write_view(
    ...
    typename std::enable_if<mp11::mp_and<
        ...
        typename is_format_tag<typename Writer::format_tag_t>::type>::value>::type* /* ptr */
    = nullptr)
{
    writer.apply(view);
}
...
inline void write_view(
    ...
    typename std::enable_if<mp11::mp_and<
        typename detail::is_write_device<FormatTag, Device>::type,
        typename is_format_tag<FormatTag>::type>::value>::type* /* ptr */
    = 0)
{
