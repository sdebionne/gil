...
struct writer_backend<Device, tiff_tag>
{
public:
...
protected:
    ...
    void write_header(const View& view)
    {
        ...
        if (!this->_info._photometric_interpretation_user_defined)
        {
            ...
            this->_info._photometric_interpretation
                = detail::photometric_interpretation<color_space_t>::value;
        }
        ...
        this->_io_dev.template set_property<tiff_planar_configuration>(
            this->_info._planar_configuration);
        ...
        this->_io_dev.template set_property<tiff_photometric_interpretation>(
            this->_info._photometric_interpretation);
