...
template <>
struct jpeg_read_support<uint8_t, rgb_t>
    : read_support_true
...
template <>
struct jpeg_read_support<uint8_t, cmyk_t>
    : read_support_true
...
template <>
struct jpeg_write_support<uint8_t, rgb_t>
    : write_support_true
    , jpeg_rw_support_base<JCS_RGB>
{
};
...
template <>
struct jpeg_write_support<uint8_t, cmyk_t>
    : write_support_true
    , jpeg_rw_support_base<JCS_CMYK>
{
};
