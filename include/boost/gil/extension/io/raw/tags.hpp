...
#    pragma warning(push)
#    pragma warning(                                                                               \
        disable : 4251)  // 'type' needs to have dll-interface to be used by clients of class
#endif
...
{
    /// Default contructor.
    image_read_info<raw_tag>() : _valid(false)
    {
    }
...
{
    /// Default constructor
    image_read_settings() : image_read_settings_base()
    {
    }
