...
template <>
struct targa_read_support<uint8_t, rgb_t> : read_support_true
{
...
template <>
struct targa_read_support<uint8_t, rgba_t> : read_support_true
{
...
template <>
struct targa_write_support<uint8_t, rgb_t> : write_support_true
{
};

template <>
struct targa_write_support<uint8_t, rgba_t> : write_support_true
{
};
