...
struct scaling_factors
{
    ...
    static_assert(
        std::integral_constant<int, A>::value == 4 || std::integral_constant<int, A>::value == 2
            || std::integral_constant<int, A>::value == 1,
        "");

    static_assert(
        std::integral_constant<int, B>::value == 4 || std::integral_constant<int, B>::value == 2
    ...
    static constexpr int ss_Y = mp11::mp_if_c<
        std::integral_constant<int, B>::value == 0,
...
struct subchroma_image_deref_fn
{
    ...
    /// constructor
    subchroma_image_deref_fn(
        const plane_locator_t& y_locator,
    ...
    result_type operator()(const point_t& p) const
    {
        ...
        plane_locator_t v
            = _v_locator.xy_at(p.x / scaling_factors_t::ss_X, p.y / scaling_factors_t::ss_X);
        plane_locator_t u
            = _u_locator.xy_at(p.x / scaling_factors_t::ss_X, p.y / scaling_factors_t::ss_X);

        return value_type(at_c<0>(*y), at_c<0>(*v), at_c<0>(*u));
    }

    ///
    const plane_locator_t& y_locator() const
    {
        return _y_locator;
    }
    const plane_locator_t& v_locator() const
    {
        return _v_locator;
    }
    const plane_locator_t& u_locator() const
    {
        return _u_locator;
    }
...
///
////////////////////////////////////////////////////////////////////////////////////////
template <typename Locator, typename Factors = mp11::mp_list_c<int, 4, 4, 4>>
...
public:
    ...
    const point_t& y_dimension() const
    {
        return _y_dimensions;
    }
    const point_t& v_dimension() const
    {
        return _v_dimensions;
    }
    const point_t& u_dimension() const
    {
        return _u_dimensions;
    }

    const plane_locator_t& y_plane() const
    {
        return get_deref_fn().y_locator();
    }
    const plane_locator_t& v_plane() const
    {
        return get_deref_fn().v_locator();
    }
    const plane_locator_t& u_plane() const
    {
        return get_deref_fn().u_locator();
    }
...
template <typename Locator, typename Factors>
struct channel_type<subchroma_image_view<Locator, Factors>> : public channel_type<Locator>
{
};

template <typename Locator, typename Factors>
struct color_space_type<subchroma_image_view<Locator, Factors>> : public color_space_type<Locator>
{
};
...
template <typename Locator, typename Factors>
struct is_planar<subchroma_image_view<Locator, Factors>> : public is_planar<Locator>
{
};
...
public:
    ...
    using locator_t = typename subchroma_image_locator<pixel_locator_t, Factors>::type;
...
private:
    void init()
    {
        ...
        defer_fn_t deref_fn(
            view(_y_plane).xy_at(0, 0), view(_v_plane).xy_at(0, 0), view(_u_plane).xy_at(0, 0));
        ...
        _view
            = view_t(_y_plane.dimensions(), _v_plane.dimensions(), _u_plane.dimensions(), locator);
    }
...
struct channel_type<subchroma_image<Pixel, Factors, Alloc>> : channel_type<Pixel>
{
};

template <typename Pixel, typename Factors, typename Alloc>
struct color_space_type<subchroma_image<Pixel, Factors, Alloc>> : color_space_type<Pixel>
{
};

template <typename Pixel, typename Factors, typename Alloc>
struct channel_mapping_type<subchroma_image<Pixel, Factors, Alloc>> : channel_mapping_type<Pixel>
{
};

template <typename Pixel, typename Factors, typename Alloc>
struct is_planar<subchroma_image<Pixel, Factors, Alloc>> : std::integral_constant<bool, false>
{
};
...
inline const typename subchroma_image<Pixel, Factors>::view_t& view(
    subchroma_image<Pixel, Factors>& img)
{
    return img._view;
}

template <typename Pixel, typename Factors>
inline const typename subchroma_image<Pixel, Factors>::const_view_t const_view(
    subchroma_image<Pixel, Factors>& img)
{
...
void fill_pixels(const subchroma_image_view<Locator, Factors>& view, const Pixel& value)
{
    using channel_t = typename subchroma_image<Pixel, Factors>::plane_view_t::value_type;
...
/////////////////////////////////////////////////////////////////////////////////////////
template <typename Pixel, typename Factors>
typename subchroma_image<Pixel, Factors>::view_t subchroma_view(
    std::size_t y_width,
    std::size_t y_height,
    unsigned char* y_base)
{
    ...
    unsigned char* v_base = u_base + (y_width / scaling_factors_t::ss_X) * u_channel_size;
    ...
    plane_view_t v_plane = interleaved_view(
        y_width / scaling_factors_t::ss_X,
    ...
    using defer_fn_t
        = subchroma_image_deref_fn<typename subchroma_image<Pixel, Factors>::pixel_locator_t, Factors>;

    defer_fn_t deref_fn(y_plane.xy_at(0, 0), v_plane.xy_at(0, 0), u_plane.xy_at(0, 0));
