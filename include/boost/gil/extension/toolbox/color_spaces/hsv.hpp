...
using hsv_t
    = mp11::mp_list<hsv_color_space::hue_t, hsv_color_space::saturation_t, hsv_color_space::value_t>;
    ...
    void operator()(const P1& src, P2& dst) const
    {
        ...
        else
        {
            if ((std::abs)(temp_red - max_color) < 0.0001f)
            {
                ...
                temp_green
                >= max_color)  // means == but >= avoids compiler warning; color is never greater than max
            {
