...
#define BOOST_GIL_TEST_GENERATE_TILE_STRIP_COMPARISON_BIT_ALIGNED_RGB(z, n, data)                  \
    ...
    {                                                                                              \
        ...
        std::string filename_strip(                                                                \
            tiff_in_GM + "tiger-"                                                                  \
            + BOOST_PP_STRINGIZE(BOOST_PP_TUPLE_ELEM(2, 0, data)) + "-strip-"                                                           \
                + BOOST_PP_STRINGIZE(BOOST_PP_TUPLE_ELEM(2, 1, data)) + "-");                      \
        std::string filename_tile(                                                                 \
            tiff_in_GM + "tiger-"                                                                  \
            + BOOST_PP_STRINGIZE(BOOST_PP_TUPLE_ELEM(2, 0, data)) + "-tile-"                                                            \
                + BOOST_PP_STRINGIZE(BOOST_PP_TUPLE_ELEM(2, 1, data)) + "-");                      \
        std::string padding("");                                                                   \
