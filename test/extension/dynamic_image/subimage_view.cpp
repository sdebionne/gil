...
struct test_subimage_equals_image_quadrants
{
    ...
    void operator()(Image const&)
    {
        ...
        gil::apply_operation(
            v0, fixture::fill_any_view<image_t>({2, 3, 6, 7}, gil::const_view(i1)[0]));
        //  quadrant 2
        auto const i2 = fixture::create_image<image_t>(2, 2, 128);
        gil::apply_operation(
            v0, fixture::fill_any_view<image_t>({0, 1, 4, 5}, gil::const_view(i2)[0]));
        //  quadrant 3
        auto const i3 = fixture::create_image<image_t>(2, 2, 64);
        gil::apply_operation(
            v0, fixture::fill_any_view<image_t>({8, 9, 12, 13}, gil::const_view(i3)[0]));
        //  quadrant 4
        auto const i4 = fixture::create_image<image_t>(2, 2, 32);
        gil::apply_operation(
            v0, fixture::fill_any_view<image_t>({10, 11, 14, 15}, gil::const_view(i4)[0]));
