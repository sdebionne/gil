...
void test_dx_sobel_kernel()
{
    ...
    BOOST_TEST_ALL_EQ(
        kernel.begin(), kernel.end(), gil::detail::dx_sobel.begin(), gil::detail::dx_sobel.end());
}
...
void test_dx_scharr_kernel()
{
    ...
    BOOST_TEST_ALL_EQ(
        kernel.begin(), kernel.end(), gil::detail::dx_scharr.begin(), gil::detail::dx_scharr.end());
}
...
void test_dy_sobel_kernel()
{
    ...
    BOOST_TEST_ALL_EQ(
        kernel.begin(), kernel.end(), gil::detail::dy_sobel.begin(), gil::detail::dy_sobel.end());
}
...
void test_dy_scharr_kernel()
{
    ...
    BOOST_TEST_ALL_EQ(
        kernel.begin(), kernel.end(), gil::detail::dy_scharr.begin(), gil::detail::dy_scharr.end());
}
