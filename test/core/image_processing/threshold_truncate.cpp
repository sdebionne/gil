...
void fill_original_gray()
{
    ...
    gil::fill_pixels(
        gil::subimage_view(
            gil::view(original_gray), 0, 0, original_gray.width(), original_gray.height() / 2),
...
void fill_original_rgb()
{
    ...
    gil::fill_pixels(
        gil::subimage_view(
            gil::view(original_rgb), 0, 0, original_rgb.width(), original_rgb.height() / 2),
        gil::rgb8_pixel_t(50, 85, 135));
    gil::fill_pixels(
        gil::subimage_view(
...
void threshold_gray_to_gray()
{
    ...
    gil::fill_pixels(
        gil::subimage_view(
            gil::view(expected_gray), 0, 0, original_gray.width(), original_gray.height() / 2),
        gil::gray8_pixel_t(50));
    gil::fill_pixels(
        gil::subimage_view(
...
void threshold_rgb_to_rgb()
{
    ...
    gil::fill_pixels(
        gil::subimage_view(
            gil::view(expected_rgb), 0, 0, original_rgb.width(), original_rgb.height() / 2),
        gil::rgb8_pixel_t(50, 85, 100));
    gil::fill_pixels(
        gil::subimage_view(
            gil::view(expected_rgb),
            0,
            original_rgb.height() / 2,
            original_rgb.width(),
            original_rgb.height() / 2),
