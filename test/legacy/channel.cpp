...
{
    // equality comparable
    friend bool operator==(const channel_archetype&, const channel_archetype&)
    {
        return true;
    }
    friend bool operator!=(const channel_archetype&, const channel_archetype&)
...
struct channel_value_archetype : public channel_archetype
{
    ...
    channel_value_archetype(const channel_value_archetype&)
    {
    }  // copy constructible
    channel_value_archetype& operator=(const channel_value_archetype&)
    {
        return *this;
    }  // assignable
