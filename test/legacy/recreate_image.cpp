...
std::size_t is_planar_impl(const std::size_t size_in_units, const std::size_t, std::false_type)
{
...
std::size_t total_allocated_size_in_bytes(const typename View::point_t& dimensions)
{
    ...
    const std::size_t _channels_in_image = mp11::mp_eval_if<
        is_pixel<typename View::value_type>,
        num_channels<View>,
